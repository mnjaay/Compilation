...
{
  "$end", "error", "$undefined", "MOT", "SYM_AT", "SYM_HASH",
  "SYM_DOLLAR", "SEP", "END", "$accept", "programme", "phrases", "phrase", 0
};
#endif
...
{
       6,    -6,     5,    10,    11,     3,     0,    -7,    -7,     2,
       8,     9,    -7,    -7,    14,    15,    16,    13,    17,    18,
      19,    20,    23,    21,    22,    24,    -7,    -7,    -7
};
...
{
      -2,     1,     8,    12,     2,     3,     4,     1,     9,    14,
       2,     3,     4,    10,    11,    15,    16,    17,    18,    19,
      20,     0,    23,    24,    21,    22,    25,     0,     0,    26,
      27,    13,    28
};
...
{
       0,     1,     4,     5,     6,    10,    11,    12,     8,     3,
       3,     3,     0,    12,     7,     7,     7,     3,     3,     3,
       7,     7,     7,     3,     3,     3,     8,     8,     8
};
